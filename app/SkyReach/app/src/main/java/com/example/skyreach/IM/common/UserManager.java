...
import com.example.skyreach.IM.listener.OnCallStateListener;
...
public class UserManager {
     ...
     **/
    // online
    private long appId = 2882303761518018062L;
    private String appKey = "5761801847062";
    private String appSecret = "X3ZZj48z14a5m3Dt21VYFA==";
...
//        onHandleMIMCMsgListener.onHandleGroupMessage(chatMsg);
    ...
    public MIMCUser newUser(String appAccount){
        ...
        mUser = MIMCUser.newInstance(appId, appAccount, YL.getContext().getExternalFilesDir(null).getAbsolutePath());
        // staging
