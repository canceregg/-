...
package com.example.skyreach.IM.proto;
...
public final class AV {
  ...
  public interface MIMCRtsPacketOrBuilder extends
     ...
     * <code>optional .MIMC_RTS_CODEC_TYPE codecType = 2;</code>
     */
    AV.MIMC_RTS_CODEC_TYPE getCodecType();
  ...
  public  static final class MIMCRtsPacket extends
     ...
     * <code>optional .MIMC_RTS_TYPE type = 1;</code>
     */
    public AV.MIMC_RTS_TYPE getType() {
      AV.MIMC_RTS_TYPE result = AV.MIMC_RTS_TYPE.forNumber(type_);
      return result == null ? AV.MIMC_RTS_TYPE.AUDIO : result;
    }
    /**
     * <code>optional .MIMC_RTS_TYPE type = 1;</code>
     */
    private void setType(AV.MIMC_RTS_TYPE value) {
      if (value == null) {
     ...
     * <code>optional .MIMC_RTS_CODEC_TYPE codecType = 2;</code>
     */
    public AV.MIMC_RTS_CODEC_TYPE getCodecType() {
      AV.MIMC_RTS_CODEC_TYPE result = AV.MIMC_RTS_CODEC_TYPE.forNumber(codecType_);
      return result == null ? AV.MIMC_RTS_CODEC_TYPE.OS_CODEC : result;
    }
    /**
     * <code>optional .MIMC_RTS_CODEC_TYPE codecType = 2;</code>
     */
    private void setCodecType(AV.MIMC_RTS_CODEC_TYPE value) {
      if (value == null) {
        throw new NullPointerException();
      }
  ...
  bitField0_ |= 0x00000008;
    ...
    public static AV.MIMCRtsPacket parseFrom(
    ...
    public static AV.MIMCRtsPacket parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    }
    ...
    public static AV.MIMCRtsPacket parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
    ...
    public static AV.MIMCRtsPacket parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input);
    }
    public static AV.MIMCRtsPacket parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(AV.MIMCRtsPacket prototype) {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          AV.MIMCRtsPacket, Builder> implements
        // @@protoc_insertion_point(builder_implements:MIMCRtsPacket)
        AV.MIMCRtsPacketOrBuilder {
      // Construct using AV.MIMCRtsPacket.newBuilder()
      private Builder() {
       ...
       * <code>optional .MIMC_RTS_TYPE type = 1;</code>
       */
      public Builder setType(AV.MIMC_RTS_TYPE value) {
        copyOnWrite();
       ...
       * <code>optional .MIMC_RTS_CODEC_TYPE codecType = 2;</code>
       */
      public Builder setCodecType(AV.MIMC_RTS_CODEC_TYPE value) {
        copyOnWrite();
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          ...
          AV.MIMCRtsPacket other = (AV.MIMCRtsPacket) arg1;
            ...
            while (!done) {
              ...
              switch (tag) {
                ...
                case 8: {
                  ...
                  AV.MIMC_RTS_TYPE value = AV.MIMC_RTS_TYPE.forNumber(rawValue);
                  if (value == null) {
                ...
                case 16: {
                  int rawValue = input.readEnum();
                  AV.MIMC_RTS_CODEC_TYPE value = AV.MIMC_RTS_CODEC_TYPE.forNumber(rawValue);
                  if (value == null) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (AV.MIMCRtsPacket.class) {
              if (PARSER == null) {
    ...
    private static final AV.MIMCRtsPacket DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new MIMCRtsPacket();
      DEFAULT_INSTANCE.makeImmutable();
    }

    public static AV.MIMCRtsPacket getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
