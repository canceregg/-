...
public class LoginIF
{
    ...
    * */
    ...
    //修改用户权限
    public Boolean ChangeUserType(String userId, int userType)
    {
        final String url = "http://111.230.183.219/myapp2/ChangeUserType";
        List<User> userList = new ArrayList<User>();
        User u =  new User();
        u.setUserId(userId);
    ...
    {
        final String url = "http://111.230.183.219/myapp2/ResetUserNameServlet";
        List<User> userList = new ArrayList<User>();
        User u =  new User();
        u.setUserId(userId);
