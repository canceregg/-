...
import com.example.skyreach.IM.TheChat;
...
public class Main extends TabActivity implements View.OnClickListener{
    ...
    //定义Intent对象
    private Intent intentOne,intentTwo,intentThree,intentFour;
    ...
    private void View(){
        ...
        intentThree = new Intent(this, TheChat.class);
        intentFour = new Intent(this, minePage.class);
    ...
    private void Data(){
        ...
        tabHost.addTab(buildTabSpec(FOUR, intentFour));
        tabHost.setCurrentTabByTag(One);

        image(1);
    }
    private void image(int pos){
        TextView textView[]=new TextView[]{text1,text2,text3,text4};
        ImageView imageView[]=new ImageView[]{image1,image2,image3,image4};
        for(int i=0;i<4;i++){
