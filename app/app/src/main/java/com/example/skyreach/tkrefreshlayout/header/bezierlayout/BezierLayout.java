package com.example.skyreach.tkrefreshlayout.header.bezierlayout;
...
import com.example.skyreach.tkrefreshlayout.OnAnimEndListener;
    ...
    public void startAnim(float maxHeadHeight, float headHeight) {
        ...
        waveAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                waveView.setWaveHeight((Integer) animation.getAnimatedValue() / 2);
                waveView.invalidate();
