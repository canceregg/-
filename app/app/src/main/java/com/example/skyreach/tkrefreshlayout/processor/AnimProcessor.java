package com.example.skyreach.tkrefreshlayout.processor;
...
import com.example.skyreach.tkrefreshlayout.utils.LogUtil;
import com.example.skyreach.tkrefreshlayout.utils.ScrollingUtil;
...
//        offerToQueue(va);
    ...
    private void offerToQueue(Animator animator) {
        ...
        if (animQueue == null) {
            animQueue = new LinkedList<Animator>();
        }
